...
proc compareExchangeWeak*[T, A](p: ptr Nuclear[T]; expected: ptr T; desired: T; order: static MemoryOrder = moSeqCst): bool {.inline.} =
...
proc compareExchange*[T, A, C](
    p: var Nuclear[T]; expected: var A; desired: C;
...
proc compareExchangeWeak*[T, A, C](
    p: var Nuclear[T]; expected: var A; desired: C;
    success, failure: static MemoryOrder
    ): bool {.inline.} =
